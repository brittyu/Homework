...
class Twig {
    ...
    function __construct($debug = false) {
        ...
        // 静态文件 url 生成函数
        $resource_url = new Twig_SimpleFunction('resource_url', function($file) {
            $CI =& get_instance();
        ...
        $this->_twig->addFunction($resource_url);
        ...
        // 分页pagination 生成函数
		$pagination = new Twig_SimpleFunction('pagination', function() {
			$CI = &get_instance();
			$CI->load->library('pagination');
			return $CI->pagination->create_links();
		});
		$this->_twig->addFunction($pagination);
