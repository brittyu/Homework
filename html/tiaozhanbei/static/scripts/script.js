    function preDisplay() {
	    ...
	    aNum[index].style.display="block";
            clearInterval(timer);
        ...
        for (t = 0; t < navLi.length; t++) {
           navLi[t].index = t;
            navLi[t].onmouseover = function () {
                return function () {
                    var that = this.index;
                    navLi[that].style.cssText = "background-image:url(" + "http://tzb2015.gdut.edu.cn/static/images/nav_ho.png);background-position:center;";
                 };
            }(t);
